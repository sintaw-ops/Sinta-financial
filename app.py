...
def get_supabase_conn():
    """Membuka koneksi aman ke Supabase dengan memaksakan SSL & Timeout Protection."""
    return psycopg2.connect(
        ...
        sslmode="require",      # WAJIB: Memaksa enkripsi SSL yang diminta Supabase
        connect_timeout=10      # WAJIB: Mencegah hang di Streamlit Cloud
    )
